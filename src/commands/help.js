const helpCommand = (ctx) => {
  ...
  \nAll you need is to press /location command, answer few questions about your location (e.g. city or village - don't worry, even small villages are supported), and that's it! Notification at 06:00 will appear *only if percipitations are expected* (e.g. rain or snow during the day). \n\nFeel free to set up different locations during the day and /check weather forecast for them, but remember - daily notification comes only once for your last saved place!
